...
#define('VIRTUAL_PATH', 'http://monkeework.com/wn17/app'); # Virtual (web) 'root' of application for images, JS & CSS files
#define('VIRTUAL_PATH', 'http://wn17.monkeework.com/app'); # Virtual (web) 'root' of application for images, JS & CSS files
define('VIRTUAL_PATH', 'http://localhost/git250-17q1/app/'); # Virtual (web) 'root' of application for images, JS & CSS files

#define('PHYSICAL_PATH', '/PHYSICAL-PATH-HERE/'); # Physical (PHP) 'root' of application for file & upload reference
define('PHYSICAL_PATH', '/Applications/AMPPS/www/git250-17q1/app/'); # Physical (PHP) 'root' of application for file & upload reference
...
define('SUPPORT_EMAIL', 'monkeework@gmail.com.com'); # Email of site support
define('PREFIX', 'wn17_'); #Prefix to add uniqueness to your DB table names.  Limits hackability, naming collisions
...
$config->slogan = 'Web Database ITC281 class website.';
$config->metaDescription = 'Welcome Web Database ITC281 class website.';
$config->metaKeywords = 'database,javascript,mysql,php';
$config->metaRobots = 'no index, no follow';
$config->banner = 'itc250'; #goes inside header - can be overwritten
$config->copyright = 'YOUR NAME HERE &copy; 2014 - ' . date('Y'); #goes inside footer - can be overwritten
...
// Click on site banner to go to 'home' page

#$nav1['index.php'] = "Home~A model for building largely static web pages";
$nav1['proj01/index.php'] = "(P1) Temp Converter~Switch case statement, math";
$nav1['proj02/index.php'] = "(P2) Food Truck~Post Back form with classes, error handling, and validation";
$nav1['surveys/'] = "(p3) Surveys~The entrance to our Survey App";
...
// # needed to trigger modal


#$nav1[THIS_PAGE . '#'] = "Modal~modal version of contact form";
